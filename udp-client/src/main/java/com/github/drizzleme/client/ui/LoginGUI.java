...
public class LoginGUI extends JFrame{
    ...
    private void initViews()
    {
        ...
        editServerIp.setText(ConfigEntity.serverIP);	// default value
        editServerPort.setText(String.valueOf(ConfigEntity.serverUDPPort));	// default value
        ...
        bottomPanel.add(
                new JLabel(new ImageIcon(LoginGUI.class.getClassLoader().getResource("res/copyright_img.png")))
                , BorderLayout.CENTER);
